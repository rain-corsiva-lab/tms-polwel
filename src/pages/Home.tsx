  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">POLWEL Training Management System - {user.role.replace("_", " ").toLowerCase()}</p>
      </div>
          ...
          <>
            <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => navigate("/polwel-users")}>
              <CardHeader>
                ...
                <CardDescription>Manage POLWEL users, trainers, and client organisations</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => navigate("/client-organisations")}>
              <CardHeader>
                ...
                <CardDescription>View and manage client organisations and partnerships</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => navigate("/course-creation")}>
              <CardHeader>
                ...
                <CardDescription>Create, edit, and manage training courses</CardDescription>
              </CardHeader>
            </Card>
          </>
        )}
          ...
          <>
            <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => navigate("/users")}>
              <CardHeader>
                ...
                <CardDescription>Manage learners from your organisation</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => navigate("/course-creation")}>
              <CardHeader>
                ...
                <CardDescription>View and request training courses</CardDescription>
              </CardHeader>
            </Card>
          </>
        )}
      ...
      {/* Recent Activity or Organisation-specific content */}
      <Card>
        <CardHeader>
        ...
        <CardContent>
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">• System maintenance scheduled for next Sunday</p>
            <p className="text-sm text-muted-foreground">• New training modules available</p>
            <p className="text-sm text-muted-foreground">• Quarterly reports are now ready for review</p>
          </div>
        </CardContent>
      </Card>
    </div>
