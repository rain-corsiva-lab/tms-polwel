...
export default function RunsByOrganisation() {
  ...
  const [filterOptions, setFilterOptions] = useState<FilterOptions>({ organizations: [], statuses: [] });
  ...
  const handleExportToExcel = async () => {
    try {
      ...
      XLSX.utils.book_append_sheet(wb, ws, "Runs by Organisation");
      XLSX.writeFile(wb, "Runs_by_Organisation.xlsx");
